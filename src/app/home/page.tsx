...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <Link
        href="/orden"
        className="btn-glow-pulse fixed bottom-3 right-3 z-40 inline-flex -rotate-2 items-center rounded-[18px] border-2 border-white/85 bg-[var(--brand)] px-4 py-2.5 text-[11px] font-extrabold uppercase tracking-[0.16em] text-white transition hover:rotate-0 hover:bg-[var(--brand-dark)] sm:bottom-4 sm:right-4 sm:px-5 sm:py-3 sm:text-xs"
      >
        PEDI AHORA 👇
      </Link>
    </>
