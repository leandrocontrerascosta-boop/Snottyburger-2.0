...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <Link
        href="/orden"
        className="fixed bottom-3 right-3 z-40 rounded-full bg-[var(--brand)] px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.12em] text-white shadow-[0_12px_24px_rgba(191,36,63,0.28)] transition hover:bg-[var(--brand-dark)] sm:bottom-4 sm:right-4 sm:px-5 sm:py-3 sm:text-xs"
      >
        Pedir Ahora
      </Link>
    </>
